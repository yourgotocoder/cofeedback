...
interface FeedbackQuestions {
    ...
    "Program Elective"?: SubjectQuestions;
...
const MainPage = () => {
    ...
    const fetchQuestions = async () => {
        const response = await fetch("QuestionsThirdSemIoT.json", {
            headers: {
    ...
    const handleSubmit = async () => {
        ...
        const response = await fetch(
            `${process.env.REACT_APP_API_ROUTE}submit-feedback?sem=3&branch=iot`,
            {
                method: "POST",
        ...
        content = (
            ...
            >
                <Card sx={{ minWidth: "60vw", maxWidth: "95vw", margin: "auto" }}>
                    <CardContent>
                        {!!questions["Program Elective"] &&
                            Object.keys(questions["Program Elective"]).length > 1 && (
                                <div>
                                    <Typography
                                        sx={{
                                            fontSize: 14,
                                    ...
                                    >
                                        <Stepper activeStep={activeStep} orientation="vertical">
                                            <Step>
                                                <StepLabel>Select Electives</StepLabel>
                                                <StepContent
                                                    TransitionProps={{
                                                        unmountOnExit: false,
                                                    }}
                                                        ...
                                                        <Box>
                                                            {!!questions["Program Elective"] && (
                                                                <SelectSubjects
                                                                    ...
                                                                    subjectObject={questions["Program Elective"]}
